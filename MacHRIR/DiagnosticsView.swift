        ...
        VStack(spacing: 0) {
            ...
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    // Aggregate Device Details (if any exist)
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                ChecklistRow(
                    ...
                    actionTitle: !diagnosticsManager.diagnostics.microphonePermissionGranted ? "Open Settings" : nil,
                    action: {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 8) {
                ForEach(diagnosticsManager.diagnostics.aggregateHealth) { health in
                    AggregateDeviceRow(health: health)
                }
            }
        }
    }
...
class DiagnosticsWindowController: NSWindowController {
    ...
    private init() {
        ...
        window.title = "MacHRIR Diagnostics"
        window.center()
