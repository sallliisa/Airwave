...
|---|---|---|---|---|---|
| 001 | Make real-time audio processing frame-safe and non-blocking | P1 | L | — | TODO |
| 002 | Make preset activation cancellable, deduplicated, and latest-wins | P1 | M | 001 | TODO |
| 003 | Make device discovery responsive and contributor workflow reproducible | P2 | M | 001 | TODO |
