...
final class ProductSurfaceTests: XCTestCase {
    func testSettingsWindowContentStateSwitchesModesAndLimitsSetupExit() {
        ...
        XCTAssertEqual(SettingsPage.devices.title, "Registered Devices")
    ...
    func testSettingsSurfaceUsesOneWindowAndOneSharedMenuBarViewModelPath() throws {
        ...
        XCTAssertTrue(settings.contains("title: \"Registered Devices\""))
        ...
        XCTAssertTrue(settings.contains("profiles.editingTarget"))
        XCTAssertTrue(settings.contains("ForEach(profiles.targets)"))
        XCTAssertTrue(appDelegate.contains("OutputDeviceDiscoveryCoordinator.shared.launch()"))
    ...
    func testDeviceManagementSurfacePreservesFixedWindowAndAccessibleDestructiveFlow() throws {
        ...
        XCTAssertTrue(management.contains("Select it from the device selector to recreate its profile."))
        XCTAssertFalse(management.contains("title: \"Remembered Devices\""))
